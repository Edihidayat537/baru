...
$ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, 'https://ca6cl11co4ja5se6.bukaolshop.com/api/camden/v1/user-register-phone');
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_POST, 1);
  curl_setopt($ch, CURLOPT_POSTFIELDS, $data);
$headers = array();
$headers[] ="ost: ca6cl11co4ja5se6.apy.pw/lumenpay";
...
$ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, 'https://apy.pw/lumenpay/api/camden/v1/check-register-otp');
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_POST, 1);
...
$ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, 'https://ca6cl11co4ja5se6.apy.pw/lumenpay/api/camden/v1/add-user-screen-tracking');https://ca6cl11co4ja5se6.apy/lumenpay/api/camden/v1/add-user-screen-tracking
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_POST, 1);
...
$ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, 'https://ca6cl11co4ja5se6.apy.pw/lumenpay/api/camden/v1/register-user');
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_POST, 1);
...
//$headers[] ="Accept-Language: id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7";
 ...
 $json = json_decode($result,true);
//var_dump($result);
$a = explode('<a href="https://bukaolshop.com/page/verify-email?token=', $result);
$b = explode('&amp;email='.$email.'@vomoto.com" target="_blank"><img height="auto" src="https://bukaolshop.com/images/check.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"></a>', $a[1]);
$cc = $b[0];
$udid = $json["uid"];
...
$data6 = '{"token":"'.$cc.'"}';
$ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, 'https://ca6cl11co4ja5se6.bukaolshop.com/api/camden/v1/verify-email-user');
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_POST, 1);
  curl_setopt($ch, CURLOPT_POSTFIELDS, $data6);
$headers[] ="Host: ca6cl11co4ja5se6.bukaolshop.com";
...
$headers[] ="content-type: application/json;charset=UTF-8";
$headers[] ="origin: https://bukaolshop.com/page/confirm_user?sukses";
$headers[] ="sec-fetch-site: same-site";
$headers[] ="sec-fetch-mode: cors";
$headers[] ="sec-fetch-dest: empty";
$headers[] ="referer: https://bukaolshop.com/page/confirm_user?sukses";
//$headers[] ="accept-encoding: gzip, deflate, br";
//$headers[] ="accept-language: id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7";
  curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
 $result = curl_exec($ch);
